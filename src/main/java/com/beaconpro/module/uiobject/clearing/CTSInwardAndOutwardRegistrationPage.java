...
public class CTSInwardAndOutwardRegistrationPage 
{
	WebDriver driver;
	...
	/***************Outward Registration Window elements*********************/
	
	@FindBy (xpath=".//*[@id='CreateMenu']/li[9]/ul/li[1]/ul/li[1]/a")
	public WebElement MICRRegistrationLink;
	
	public CTSInwardAndOutwardRegistrationPage (WebDriver driver)
	...
	*/
	...
	public void OpenCTSOutwardRegistrnWindow()
	{
		MenuList ObjMenu=new MenuList(driver);
		ObjMenu.Open_window(MICRRegistrationLink);
	}
	public void CTS_Outward_RegistrationProcess(String ClearingType,String ProductGroup,String Productname,String Productacno,
			String Instrtype,String  Prefix,String InstrNo,String InstDate,String Amount) throws InterruptedException
	{
		OpenCTSOutwardRegistrnWindow();
		MicrOutstationRegistration ObjMicrReg=new MicrOutstationRegistration(driver);
		ObjMicrReg.clearingtype(ClearingType);
		ObjMicrReg.productgroup(ProductGroup);
		ObjMicrReg.ExplicitWait_elementToBeClickable(ObjMicrReg.Product);
		ObjMicrReg.product(Productname);
		ObjMicrReg.ExplicitWait_elementToBeClickable(ObjMicrReg.AcNo);
		ObjMicrReg.acno(Productacno);
		ObjMicrReg.AcNo.sendKeys(Keys.TAB);
		ObjMicrReg. custgridloading();
		ObjMicrReg.instrumenttype(Instrtype);
		ObjMicrReg.instrumentprefix(Prefix);
		ObjMicrReg.ExplicitWait_elementToBeClickable(ObjMicrReg.InstrumentNo);
		Thread.sleep(1000);
			
		ObjMicrReg.instrumentno(InstrNo);
		//mic.InstrumentNo.sendKeys(Keys.TAB);
		
			
		ObjMicrReg.ExplicitWait_elementToBeClickable(ObjMicrReg.InstrumentDate);
		//mic.ExplicitWait_elementToBeClickable(mic.Amount);
		Thread.sleep(2000);
		ObjMicrReg.selectdate(InstDate);
		ObjMicrReg.InstrumentDate.sendKeys(Keys.TAB);
		ObjMicrReg.ExplicitWait_elementToBeClickable(ObjMicrReg.Amount);
		ObjMicrReg.amount(Amount);
		ObjMicrReg.selectAnyBank();
		//mic.instrumentno(InstrNo); 
		ObjMicrReg.ExplicitWait_elementToBeClickable(ObjMicrReg.Bankbranch);
		Thread.sleep(1000);
		ObjMicrReg.selectAnyBranch();
		Thread.sleep(2000);
		ObjMicrReg.submit();
		ObjMicrReg.ExplicitWait_elementToBeClickable(ObjMicrReg.Printclosebutton);
		Thread.sleep(1000);
		ObjMicrReg.printclose();
		Thread.sleep(5000);
		System.out.println("CTS OUTWARD SAVED SUCCSFULLY");
	}
